            ...
            <div className="product__info">
                ...
                <div className="product__info__item">
                    ...
                    <div className="product__info__item__quantity">
                        <div className="product__info__item__quantity__btn" onClick={handleMinusQuantity}>
                            <AiOutlineMinus />
                        </div>
                        <div className="product__info__item__quantity__input">
                            {quantity}
                        </div>
                        <div className="product__info__item__quantity__btn" onClick={() => setQuantity(quantity + 1)}>
                            <AiOutlinePlus />
                        </div>
                    </div>
                </div>
